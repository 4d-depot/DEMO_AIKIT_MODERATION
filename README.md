...
Find more information on the [blog post](https://blog.4d.com/showcase-smart-comment-moderation-with-ai).
...
* Add your OpenAI API key from the Qodly project by clicking on the API KEY button at the top right.
* Play with this HDI.
